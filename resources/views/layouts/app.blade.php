        ...
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown" data-id="nav-atas"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="features-activities.html" class="dropdown-item has-icon" data-id="profileActivities">
                                <i class="fas fa-bolt"></i> Activities
                            </a>
                            <a href="features-settings.html" class="dropdown-item has-icon" data-id="profileSettings">

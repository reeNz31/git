...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Edit Kegiatan Usaha</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('kegiatan-usaha.update', $kegiatan_usaha) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_kegiatan_usaha') is-invalid @enderror"
                                ...
                                value="{{ old('nama_kegiatan_usaha', $kegiatan_usaha->nama_kegiatan_usaha) }}" data-id="nama-kegiatan-usaha">
                ...
                <div class="card-footer text-right">
                    ...
                    <a class="btn btn-secondary" href="{{ route('kegiatan-usaha.index') }}" data-id="cancel">Cancel</a>
                </div>
                </form>
            </div>
        </div>

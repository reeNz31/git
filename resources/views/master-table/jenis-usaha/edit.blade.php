...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Edit Jenis Usaha</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('jenis-usaha.update', $jenis_usaha) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_jenis_usaha') is-invalid @enderror"
                                ...
                                value="{{ old('nama_jenis_usaha', $jenis_usaha->nama_jenis_usaha) }}" data-id="nama-jenis-usaha">
